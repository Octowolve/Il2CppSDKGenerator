...
class GunfightBloodScoreBar
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "GunfightBloodScoreBar"));
	}
	...
	template <typename T = Il2CppArray<uintptr_t>*> T& TeamCntBGSprite() {
	...
	template <typename T = void> T UpdateBar(int32_t bloodCnt, int32_t aliveCnt, int32_t totalCnt) {
		return ((T (*)(GunfightBloodScoreBar*, int32_t, int32_t, int32_t))(Il2CppBase() + 0x402030C))(this, bloodCnt, aliveCnt, totalCnt);
	}
