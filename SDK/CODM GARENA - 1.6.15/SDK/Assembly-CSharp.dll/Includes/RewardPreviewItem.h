...
class RewardPreviewItem
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "RewardPreviewItem"));
	}
	...
	template <typename T = void> T SetData(uintptr_t data) {
		return ((T (*)(RewardPreviewItem*, uintptr_t))(Il2CppBase() + 0x354E70C))(this, data);
	}
