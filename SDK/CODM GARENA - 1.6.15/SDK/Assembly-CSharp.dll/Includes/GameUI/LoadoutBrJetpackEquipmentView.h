...
class LoadoutBrJetpackEquipmentView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameUI", "LoadoutBrJetpackEquipmentView"));
	}
	...
	template <typename T = void> T ResetAllTab() {
		return ((T (*)(LoadoutBrJetpackEquipmentView*))(Il2CppBase() + 0x234999C))(this);
	}
	template <typename T = void> T ShowFilterView() {
		return ((T (*)(LoadoutBrJetpackEquipmentView*))(Il2CppBase() + 0x2349C38))(this);
	}
	template <typename T = bool> static T ShowFilterViewm__0(uintptr_t it) {
		return ((T (*)(void *, uintptr_t))(Il2CppBase() + 0x234BEB0))(0, it);
	}
