...
class UIFlowCellTweenAnimation
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameUI", "UIFlowCellTweenAnimation"));
	}
	...
	template <typename T = void> T Awake() {
		return ((T (*)(UIFlowCellTweenAnimation*))(Il2CppBase() + 0x3ADC154))(this);
	}
	template <typename T = void> T ShowAnimation(float delayTime, bool helpEnable) {
		return ((T (*)(UIFlowCellTweenAnimation*, float, bool))(Il2CppBase() + 0x3ADC478))(this, delayTime, helpEnable);
	}
	template <typename T = Il2CppVector3> T GetLocalPosition() {
		return ((T (*)(UIFlowCellTweenAnimation*))(Il2CppBase() + 0x3ADC6E4))(this);
	}
