...
class EChainTaskStateType
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "LiveOps", "EChainTaskStateType"));
	}
	...
	template <typename T = uintptr_t> static T& Processing() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
