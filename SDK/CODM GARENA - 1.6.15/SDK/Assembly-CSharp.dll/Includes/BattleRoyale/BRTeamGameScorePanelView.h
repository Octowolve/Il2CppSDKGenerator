...
class BRTeamGameScorePanelView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "BattleRoyale", "BRTeamGameScorePanelView"));
	}
	...
	template <typename T = void> T SetCampView(uintptr_t localPlayerCamp) {
		return ((T (*)(BRTeamGameScorePanelView*, uintptr_t))(Il2CppBase() + 0x262B76C))(this, localPlayerCamp);
	}
	template <typename T = void> T SetCampScoreView(uintptr_t localPlayerCamp) {
		return ((T (*)(BRTeamGameScorePanelView*, uintptr_t))(Il2CppBase() + 0x262BAC0))(this, localPlayerCamp);
	}
