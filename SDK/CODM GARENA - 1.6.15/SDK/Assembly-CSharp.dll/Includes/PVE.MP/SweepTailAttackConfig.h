...
class SweepTailAttackConfig
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "PVE.MP", "SweepTailAttackConfig"));
	}
	...
	template <typename T = float> T get_TotalDuration() {
		return ((T (*)(SweepTailAttackConfig*))(Il2CppBase() + 0x435BB2C))(this);
	}
