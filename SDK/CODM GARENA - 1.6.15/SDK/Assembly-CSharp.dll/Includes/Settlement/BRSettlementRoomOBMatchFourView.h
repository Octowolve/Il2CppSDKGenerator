...
class BRSettlementRoomOBMatchFourView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Settlement", "BRSettlementRoomOBMatchFourView"));
	}
	...
	template <typename T = uintptr_t> T get_sds() {
		return ((T (*)(BRSettlementRoomOBMatchFourView*))(Il2CppBase() + 0x3C2DB2C))(this);
	}
	template <typename T = void> T InitTopView() {
		return ((T (*)(BRSettlementRoomOBMatchFourView*))(Il2CppBase() + 0x3C2D550))(this);
	}
