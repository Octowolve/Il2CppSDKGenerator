...
class CodmSingleRechargeView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameUI", "CodmSingleRechargeView"));
	}
	...
	template <typename T = void> T Init() {
		return ((T (*)(CodmSingleRechargeView*))(Il2CppBase() + 0x3DEEDB0))(this);
	}
	template <typename T = void> T SetInfo() {
		return ((T (*)(CodmSingleRechargeView*))(Il2CppBase() + 0x3DEEE58))(this);
	}
	template <typename T = void> T xLuaBaseProxy_Init() {
		return ((T (*)(CodmSingleRechargeView*))(Il2CppBase() + 0x3DEEEF0))(this);
	}
