...
class SpectatingInfoFireADS
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameEngine", "SpectatingInfo_FireADS"));
	}

	template <typename T = uintptr_t> T& m_OwnerInfo() {
		return *(T*)((uintptr_t)this + 0x8);
	}
	template <typename T = bool> T& m_IsFireADS() {
	...
	template <typename T = void> T SyncSpectateInfo(bool active) {
		return ((T (*)(SpectatingInfoFireADS*, bool))(Il2CppBase() + 0x33F9E2C))(this, active);
	}
	template <typename T = void> T RecordSpectateInfo(bool active) {
		return ((T (*)(SpectatingInfoFireADS*, bool))(Il2CppBase() + 0x33F9ECC))(this, active);
	}
	template <typename T = void> T InitBySpectateInfo() {
		return ((T (*)(SpectatingInfoFireADS*))(Il2CppBase() + 0x33F9F74))(this);
	}
	template <typename T = void> T HandleSpectateInfo(bool active) {
		return ((T (*)(SpectatingInfoFireADS*, bool))(Il2CppBase() + 0x33FA00C))(this, active);
	}
	template <typename T = void> T UpdateSpectateInfo() {
		return ((T (*)(SpectatingInfoFireADS*))(Il2CppBase() + 0x33FA0AC))(this);
	}
	template <typename T = bool> T GetSpectateInfo() {
		return ((T (*)(SpectatingInfoFireADS*))(Il2CppBase() + 0x33FA144))(this);
	}
