...
class SyncVtolInfoMsg
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Network", "SyncVtolInfoMsg"));
	}
	...
	template <typename T = uintptr_t> T get_Content() {
		return ((T (*)(SyncVtolInfoMsg*))(Il2CppBase() + 0x439BF64))(this);
	}
	template <typename T = bool> T UseInDeadReplay() {
		return ((T (*)(SyncVtolInfoMsg*))(Il2CppBase() + 0x439C01C))(this);
	}
	template <typename T = int32_t> static T OnBuildResponseMsg(Il2CppArray<uintptr_t>* data, int32_t DataIndex, int32_t DataCount, int32_t Sequence) {
		return ((T (*)(void *, Il2CppArray<uintptr_t>*, int32_t, int32_t, int32_t))(Il2CppBase() + 0x439C0BC))(0, data, DataIndex, DataCount, Sequence);
	}
	template <typename T = bool> T xLuaBaseProxy_UseInDeadReplay() {
		return ((T (*)(SyncVtolInfoMsg*))(Il2CppBase() + 0x439C25C))(this);
	}
