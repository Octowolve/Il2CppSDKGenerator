...
class VehicleMoveResMsg
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Network", "VehicleMoveResMsg"));
	}
	...
	template <typename T = bool> T UseInDeadReplay() {
		return ((T (*)(VehicleMoveResMsg*))(Il2CppBase() + 0x43A73DC))(this);
	}
	template <typename T = int32_t> static T OnBuildResponseMsg(Il2CppArray<uintptr_t>* data, int32_t DataIndex, int32_t DataCount, int32_t Sequence) {
		return ((T (*)(void *, Il2CppArray<uintptr_t>*, int32_t, int32_t, int32_t))(Il2CppBase() + 0x43A747C))(0, data, DataIndex, DataCount, Sequence);
	}
	template <typename T = bool> T xLuaBaseProxy_UseInDeadReplay() {
		return ((T (*)(VehicleMoveResMsg*))(Il2CppBase() + 0x43A77E4))(this);
	}
