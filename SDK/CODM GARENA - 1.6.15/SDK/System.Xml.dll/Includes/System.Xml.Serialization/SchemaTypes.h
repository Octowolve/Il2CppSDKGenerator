...
public: 
	...
	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("System.Xml.dll", "System.Xml.Serialization", "SchemaTypes"));
	}
	...
	template <typename T = uintptr_t> static T& XmlSerializable() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& XmlNode() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
