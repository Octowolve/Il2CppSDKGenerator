...
class SyncCreatePackageMsg
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Network", "SyncCreatePackageMsg"));
	}
	...
	template <typename T = uintptr_t> T get_Content() {
		return ((T (*)(SyncCreatePackageMsg*))(Il2CppBase() + 0x4EAE068))(this);
	}
	template <typename T = bool> T UseInDeadReplay() {
		return ((T (*)(SyncCreatePackageMsg*))(Il2CppBase() + 0x4EAE120))(this);
	}
	template <typename T = int32_t> static T OnBuildResponseMsg(Il2CppArray<uintptr_t>* data, int32_t DataIndex, int32_t DataCount, int32_t Sequence) {
		return ((T (*)(void *, Il2CppArray<uintptr_t>*, int32_t, int32_t, int32_t))(Il2CppBase() + 0x4EAE1C0))(0, data, DataIndex, DataCount, Sequence);
	}
	template <typename T = bool> T xLuaBaseProxy_UseInDeadReplay() {
		return ((T (*)(SyncCreatePackageMsg*))(Il2CppBase() + 0x4EAE360))(this);
	}
