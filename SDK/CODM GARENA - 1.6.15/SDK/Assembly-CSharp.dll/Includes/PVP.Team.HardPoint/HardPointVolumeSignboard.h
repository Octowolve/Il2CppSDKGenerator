...
class HardPointVolumeSignboard
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "PVP.Team.HardPoint", "HardPointVolumeSignboard"));
	}
	...
	template <typename T = bool> T CheckAreaInfo() {
		return ((T (*)(HardPointVolumeSignboard*))(Il2CppBase() + 0x402DE7C))(this);
	}
	template <typename T = void> T Update() {
		return ((T (*)(HardPointVolumeSignboard*))(Il2CppBase() + 0x402E100))(this);
	}
	template <typename T = void> T UpdateBoardGOPos() {
		return ((T (*)(HardPointVolumeSignboard*))(Il2CppBase() + 0x402E628))(this);
	}
	template <typename T = void> T UpdateStateLabel() {
		return ((T (*)(HardPointVolumeSignboard*))(Il2CppBase() + 0x402E29C))(this);
	}
	template <typename T = void> T ChangAlpha(float newAlpha) {
		return ((T (*)(HardPointVolumeSignboard*, float))(Il2CppBase() + 0x402EC48))(this, newAlpha);
	}
	template <typename T = void> T xLuaBaseProxy_Update() {
		return ((T (*)(HardPointVolumeSignboard*))(Il2CppBase() + 0x402ED48))(this);
	}
	template <typename T = void> T xLuaBaseProxy_ChangAlpha(float P0) {
		return ((T (*)(HardPointVolumeSignboard*, float))(Il2CppBase() + 0x402ED50))(this, P0);
	}
