...
class WeaponFireComponentAirstrikeData
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "WeaponFireComponent_AirstrikeData"));
	}
	...
	template <typename T = float> T& AirStrikeRadius() {
		return *(T*)((uintptr_t)this + 0x16C);
	}
	template <typename T = float> T& AirStrikeTimes() {
		return *(T*)((uintptr_t)this + 0x170);
	}
	template <typename T = float> T& AirStrikeInterval() {
		return *(T*)((uintptr_t)this + 0x174);
	}
	template <typename T = int32_t> T& AirStrikeNumPerTime() {
	...
	template <typename T = void> T Deserialize(Il2CppArray<uintptr_t>* bytes, uintptr_t position, uintptr_t targetType, uintptr_t mask, uintptr_t index, uintptr_t interrupt) {
		return ((T (*)(WeaponFireComponentAirstrikeData*, Il2CppArray<uintptr_t>*, uintptr_t, uintptr_t, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x489AD6C))(this, bytes, position, targetType, mask, index, interrupt);
	}
	template <typename T = void> T xLuaBaseProxy_Deserialize(Il2CppArray<uintptr_t>* P0, uintptr_t P1, uintptr_t P2, uintptr_t P3, uintptr_t P4, uintptr_t P5) {
		return ((T (*)(WeaponFireComponentAirstrikeData*, Il2CppArray<uintptr_t>*, uintptr_t, uintptr_t, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x489B7D0))(this, P0, P1, P2, P3, P4, P5);
	}
