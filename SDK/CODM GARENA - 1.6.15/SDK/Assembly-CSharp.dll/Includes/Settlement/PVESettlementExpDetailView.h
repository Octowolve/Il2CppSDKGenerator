...
class PVESettlementExpDetailView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Settlement", "PVESettlementExpDetailView"));
	}
	...
	template <typename T = uintptr_t> T& ExpDetailKillRoot() {
	...
	template <typename T = void> T InitView(uintptr_t ds, Il2CppList<uintptr_t>* weaponItemDatas) {
		return ((T (*)(PVESettlementExpDetailView*, uintptr_t, Il2CppList<uintptr_t>*))(Il2CppBase() + 0x3B33E24))(this, ds, weaponItemDatas);
	}
	template <typename T = void> T InitExpDetailList() {
		return ((T (*)(PVESettlementExpDetailView*))(Il2CppBase() + 0x3B341B0))(this);
	}
	template <typename T = void> T T_SkipLevelUpView() {
		return ((T (*)(PVESettlementExpDetailView*))(Il2CppBase() + 0x3B3548C))(this);
	}
	template <typename T = void> T xLuaBaseProxy_InitView(uintptr_t P0, Il2CppList<uintptr_t>* P1) {
		return ((T (*)(PVESettlementExpDetailView*, uintptr_t, Il2CppList<uintptr_t>*))(Il2CppBase() + 0x3B35704))(this, P0, P1);
	}
	template <typename T = void> T xLuaBaseProxy_InitExpDetailList() {
		return ((T (*)(PVESettlementExpDetailView*))(Il2CppBase() + 0x3B3570C))(this);
	}
