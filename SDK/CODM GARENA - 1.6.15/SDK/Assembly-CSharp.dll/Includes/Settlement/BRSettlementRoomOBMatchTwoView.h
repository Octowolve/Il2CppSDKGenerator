...
class BRSettlementRoomOBMatchTwoView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Settlement", "BRSettlementRoomOBMatchTwoView"));
	}
	...
	template <typename T = uintptr_t> T get_sds() {
		return ((T (*)(BRSettlementRoomOBMatchTwoView*))(Il2CppBase() + 0x3C3106C))(this);
	}
	template <typename T = void> T InitTopView() {
		return ((T (*)(BRSettlementRoomOBMatchTwoView*))(Il2CppBase() + 0x3C30A90))(this);
	}
