...
class AIPawnBatchMoveSyncMsg
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Network", "AIPawnBatchMoveSyncMsg"));
	}
	...
	template <typename T = bool> T UseInDeadReplay() {
		return ((T (*)(AIPawnBatchMoveSyncMsg*))(Il2CppBase() + 0x3331AF4))(this);
	}
	template <typename T = int32_t> static T OnBuildResponseMsg(Il2CppArray<uintptr_t>* data, int32_t DataIndex, int32_t DataCount, int32_t Sequence) {
		return ((T (*)(void *, Il2CppArray<uintptr_t>*, int32_t, int32_t, int32_t))(Il2CppBase() + 0x3331B94))(0, data, DataIndex, DataCount, Sequence);
	}
	template <typename T = bool> T xLuaBaseProxy_UseInDeadReplay() {
		return ((T (*)(AIPawnBatchMoveSyncMsg*))(Il2CppBase() + 0x3331D14))(this);
	}
