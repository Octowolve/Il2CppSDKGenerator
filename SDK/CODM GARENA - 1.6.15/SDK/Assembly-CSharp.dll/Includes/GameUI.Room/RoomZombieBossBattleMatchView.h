...
class RoomZombieBossBattleMatchView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameUI.Room", "RoomZombieBossBattleMatchView"));
	}
	...
	template <typename T = void> T SetDifficultyInfo(uintptr_t diffculty, bool bEasy, bool bHard, bool bHell) {
		return ((T (*)(RoomZombieBossBattleMatchView*, uintptr_t, bool, bool, bool))(Il2CppBase() + 0x2138330))(this, diffculty, bEasy, bHard, bHell);
	}
