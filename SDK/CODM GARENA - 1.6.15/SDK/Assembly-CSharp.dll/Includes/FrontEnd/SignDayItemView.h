...
class SignDayItemView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "FrontEnd", "SignDayItemView"));
	}
	...
	template <typename T = void> T SetData(uintptr_t reward, int32_t DayIndex, int32_t HasSignTime, int32_t CanRemedyTime, bool bTodayHasSign) {
		return ((T (*)(SignDayItemView*, uintptr_t, int32_t, int32_t, int32_t, bool))(Il2CppBase() + 0x385E790))(this, reward, DayIndex, HasSignTime, CanRemedyTime, bTodayHasSign);
	}
	template <typename T = void> T SetRewardItemContent(Il2CppList<uintptr_t>* realItemList) {
		return ((T (*)(SignDayItemView*, Il2CppList<uintptr_t>*))(Il2CppBase() + 0x385EFDC))(this, realItemList);
	}
	template <typename T = void> T SetRewardGoldDiamond(int32_t goldCount, int32_t diamondCount) {
		return ((T (*)(SignDayItemView*, int32_t, int32_t))(Il2CppBase() + 0x385F598))(this, goldCount, diamondCount);
	}
