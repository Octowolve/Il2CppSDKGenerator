...
class LiveOpsVedioViewCA
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "LiveOps", "LiveOpsVedioView_CA"));
	}
	...
	template <typename T = void> T Init() {
		return ((T (*)(LiveOpsVedioViewCA*))(Il2CppBase() + 0x4329C24))(this);
	}
	template <typename T = void> T AdaptationView() {
		return ((T (*)(LiveOpsVedioViewCA*))(Il2CppBase() + 0x4329CD4))(this);
	}
	template <typename T = void> T UpdateView(uintptr_t activity) {
		return ((T (*)(LiveOpsVedioViewCA*, uintptr_t))(Il2CppBase() + 0x4328DBC))(this, activity);
	}
	template <typename T = Il2CppString*> T GetDefaultSpriteName() {
		return ((T (*)(LiveOpsVedioViewCA*))(Il2CppBase() + 0x432A3E8))(this);
	}
	template <typename T = void> T SetTextureContent(Il2CppString* url, bool bSuccess, uintptr_t texture) {
		return ((T (*)(LiveOpsVedioViewCA*, Il2CppString*, bool, uintptr_t))(Il2CppBase() + 0x432A4A0))(this, url, bSuccess, texture);
	}
	template <typename T = void> T xLuaBaseProxy_Init() {
		return ((T (*)(LiveOpsVedioViewCA*))(Il2CppBase() + 0x432A5EC))(this);
	}
