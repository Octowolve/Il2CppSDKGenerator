...
class ChatMessageInfoType
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Chat", "ChatMessageInfoType"));
	}
	...
	template <typename T = uintptr_t> static T& FriendInGame() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
