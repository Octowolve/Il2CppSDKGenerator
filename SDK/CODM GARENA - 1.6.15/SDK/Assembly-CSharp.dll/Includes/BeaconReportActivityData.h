...
class BeaconReportActivityData
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "BeaconReportActivityData"));
	}
	...
	template <typename T = void> T ResetData() {
		return ((T (*)(BeaconReportActivityData*))(Il2CppBase() + 0x373E468))(this);
	}
