...
class SpectatingInfoPrepareTempADSState
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameEngine", "SpectatingInfo_PrepareTempADSState"));
	}
	...
	template <typename T = void> T InitBySpectateInfo() {
		return ((T (*)(SpectatingInfoPrepareTempADSState*))(Il2CppBase() + 0x33FB81C))(this);
	}
	template <typename T = void> T SyncSpectateInfo(bool active) {
		return ((T (*)(SpectatingInfoPrepareTempADSState*, bool))(Il2CppBase() + 0x33FBA98))(this, active);
	}
	template <typename T = void> T RecordSpectateInfo(bool active) {
		return ((T (*)(SpectatingInfoPrepareTempADSState*, bool))(Il2CppBase() + 0x33FBB38))(this, active);
	}
	template <typename T = void> T HandleSpectateInfo(bool active) {
		return ((T (*)(SpectatingInfoPrepareTempADSState*, bool))(Il2CppBase() + 0x33FBBE0))(this, active);
	}
	template <typename T = void> T UpdateSpectateInfo() {
		return ((T (*)(SpectatingInfoPrepareTempADSState*))(Il2CppBase() + 0x33FBC80))(this);
	}
	template <typename T = bool> T GetSpectateInfo() {
		return ((T (*)(SpectatingInfoPrepareTempADSState*))(Il2CppBase() + 0x33FBD18))(this);
	}
