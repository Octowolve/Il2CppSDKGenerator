...
class StopModuleRequest
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "StopModuleRequest"));
	}
	...
	template <typename T = void> T Excute() {
		return ((T (*)(StopModuleRequest*))(Il2CppBase() + 0x493E8DC))(this);
	}
	template <typename T = void> T xLuaBaseProxy_Excute() {
		return ((T (*)(StopModuleRequest*))(Il2CppBase() + 0x493EA00))(this);
	}
