...
class FlowRainDrawerContainer
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "FlowRainDrawerContainer"));
	}
	...
	template <typename T = bool> T get_IsEnable() {
		return ((T (*)(FlowRainDrawerContainer*))(Il2CppBase() + 0x3CCD440))(this);
	}
