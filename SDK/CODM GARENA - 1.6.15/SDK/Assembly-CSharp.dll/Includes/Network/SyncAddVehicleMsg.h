...
class SyncAddVehicleMsg
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Network", "SyncAddVehicleMsg"));
	}
	...
	template <typename T = uintptr_t> T get_Content() {
		return ((T (*)(SyncAddVehicleMsg*))(Il2CppBase() + 0x4EA0AA8))(this);
	}
	template <typename T = bool> T UseInDeadReplay() {
		return ((T (*)(SyncAddVehicleMsg*))(Il2CppBase() + 0x4EA0B60))(this);
	}
	template <typename T = int32_t> static T OnBuildResponseMsg(Il2CppArray<uintptr_t>* data, int32_t DataIndex, int32_t DataCount, int32_t Sequence) {
		return ((T (*)(void *, Il2CppArray<uintptr_t>*, int32_t, int32_t, int32_t))(Il2CppBase() + 0x4EA0C00))(0, data, DataIndex, DataCount, Sequence);
	}
	template <typename T = bool> T xLuaBaseProxy_UseInDeadReplay() {
		return ((T (*)(SyncAddVehicleMsg*))(Il2CppBase() + 0x4EA0D80))(this);
	}
