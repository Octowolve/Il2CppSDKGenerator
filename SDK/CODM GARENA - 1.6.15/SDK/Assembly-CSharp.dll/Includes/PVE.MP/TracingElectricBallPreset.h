...
class TracingElectricBallPreset
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "PVE.MP", "TracingElectricBallPreset"));
	}

	template <typename T = float> T& lifeSpan() {
		return *(T*)((uintptr_t)this + 0xCC);
	}
	template <typename T = int32_t> T& explodeAssetID() {
		return *(T*)((uintptr_t)this + 0xD0);
	}
	template <typename T = uintptr_t> T& explodeEffect() {
	...
	template <typename T = float> T& GravitySpeed() {
