...
public: 
	...
	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GCloud", "UserInfo"));
	}
	...
	template <typename T = void> T WriteTo(uintptr_t writer) {
		return ((T (*)(UserInfo*, uintptr_t))(Il2CppBase() + 0x44445A0))(this, writer);
	}
	template <typename T = void> T ReadFrom(uintptr_t reader) {
		return ((T (*)(UserInfo*, uintptr_t))(Il2CppBase() + 0x4444678))(this, reader);
	}
