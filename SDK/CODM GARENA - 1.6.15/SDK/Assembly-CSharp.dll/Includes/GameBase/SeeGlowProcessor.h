...
class SeeGlowProcessor
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameBase", "SeeGlowProcessor"));
	}
	...
	template <typename T = bool> T get_HasRecycle() {
		return ((T (*)(SeeGlowProcessor*))(Il2CppBase() + 0x2DFD1EC))(this);
	}
	template <typename T = void> T set_HasRecycle(bool value) {
		return ((T (*)(SeeGlowProcessor*, bool))(Il2CppBase() + 0x2DFD1F4))(this, value);
	}
	template <typename T = void> T OnRecycle() {
		return ((T (*)(SeeGlowProcessor*))(Il2CppBase() + 0x2DFD1FC))(this);
	}
	template <typename T = void> T ToggleEffect(bool active, bool isEnemy) {
		return ((T (*)(SeeGlowProcessor*, bool, bool))(Il2CppBase() + 0x2DFD308))(this, active, isEnemy);
	}
