...
class EffectInstanceSeeFrontGlow
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameBase", "EffectInstance_SeeFrontGlow"));
	}
	...
	template <typename T = bool> T get_HasOcclusionEffect() {
		return ((T (*)(EffectInstanceSeeFrontGlow*))(Il2CppBase() + 0x40F6648))(this);
	}
	template <typename T = void> T ShowGlow(float duration) {
		return ((T (*)(EffectInstanceSeeFrontGlow*, float))(Il2CppBase() + 0x40F666C))(this, duration);
	}
	template <typename T = void> T SetTarget(uintptr_t target) {
		return ((T (*)(EffectInstanceSeeFrontGlow*, uintptr_t))(Il2CppBase() + 0x40F6898))(this, target);
	}
	template <typename T = void> T SetIsEnemy(bool value) {
		return ((T (*)(EffectInstanceSeeFrontGlow*, bool))(Il2CppBase() + 0x40F6B80))(this, value);
	}
	template <typename T = bool> T IsEffectActive() {
		return ((T (*)(EffectInstanceSeeFrontGlow*))(Il2CppBase() + 0x40F6C28))(this);
	}
	template <typename T = void> T SetTargetRender(uintptr_t viewType, uintptr_t root) {
		return ((T (*)(EffectInstanceSeeFrontGlow*, uintptr_t, uintptr_t))(Il2CppBase() + 0x40F6A04))(this, viewType, root);
	}
	template <typename T = void> T ToggleEffect(bool active) {
		return ((T (*)(EffectInstanceSeeFrontGlow*, bool))(Il2CppBase() + 0x40F6DEC))(this, active);
	}
	template <typename T = void> T CheckSelf() {
		return ((T (*)(EffectInstanceSeeFrontGlow*))(Il2CppBase() + 0x40F6F38))(this);
	}
	template <typename T = void> T Tick(float deltaTime) {
		return ((T (*)(EffectInstanceSeeFrontGlow*, float))(Il2CppBase() + 0x40F7074))(this, deltaTime);
	}
	template <typename T = void> T CheckGlowEffectEnable() {
		return ((T (*)(EffectInstanceSeeFrontGlow*))(Il2CppBase() + 0x40F732C))(this);
	}
	template <typename T = void> T OnRecycle() {
		return ((T (*)(EffectInstanceSeeFrontGlow*))(Il2CppBase() + 0x40F7764))(this);
	}
	template <typename T = void> T xLuaBaseProxy_SetTarget(uintptr_t P0) {
		return ((T (*)(EffectInstanceSeeFrontGlow*, uintptr_t))(Il2CppBase() + 0x40F7868))(this, P0);
	}
	template <typename T = void> T xLuaBaseProxy_CheckSelf() {
		return ((T (*)(EffectInstanceSeeFrontGlow*))(Il2CppBase() + 0x40F786C))(this);
	}
	template <typename T = void> T xLuaBaseProxy_Tick(float P0) {
		return ((T (*)(EffectInstanceSeeFrontGlow*, float))(Il2CppBase() + 0x40F7870))(this, P0);
	}
	template <typename T = void> T xLuaBaseProxy_OnRecycle() {
		return ((T (*)(EffectInstanceSeeFrontGlow*))(Il2CppBase() + 0x40F7874))(this);
	}
