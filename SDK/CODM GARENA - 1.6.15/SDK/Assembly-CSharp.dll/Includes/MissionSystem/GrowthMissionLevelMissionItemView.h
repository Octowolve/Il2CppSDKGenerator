...
class GrowthMissionLevelMissionItemView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "MissionSystem", "GrowthMissionLevelMissionItemView"));
	}
	...
	template <typename T = void> T Init() {
		return ((T (*)(GrowthMissionLevelMissionItemView*))(Il2CppBase() + 0x41F8CC0))(this);
	}
	template <typename T = void> T SetMissionDesc(uintptr_t task) {
		return ((T (*)(GrowthMissionLevelMissionItemView*, uintptr_t))(Il2CppBase() + 0x41F7FD0))(this, task);
	}
	template <typename T = void> T SetRewardItem(Il2CppList<uintptr_t>* taskRewardList) {
		return ((T (*)(GrowthMissionLevelMissionItemView*, Il2CppList<uintptr_t>*))(Il2CppBase() + 0x41F83F0))(this, taskRewardList);
	}
	template <typename T = void> T DeactivateAllRewardItem() {
		return ((T (*)(GrowthMissionLevelMissionItemView*))(Il2CppBase() + 0x41F8E74))(this);
	}
	template <typename T = void> T SetMissionStateBtn(uintptr_t newState) {
		return ((T (*)(GrowthMissionLevelMissionItemView*, uintptr_t))(Il2CppBase() + 0x41F8240))(this, newState);
	}
	template <typename T = void> T xLuaBaseProxy_Init() {
		return ((T (*)(GrowthMissionLevelMissionItemView*))(Il2CppBase() + 0x41F9070))(this);
	}
