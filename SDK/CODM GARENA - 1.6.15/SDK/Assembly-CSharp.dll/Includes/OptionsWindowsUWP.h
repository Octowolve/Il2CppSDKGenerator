...
class OptionsWindowsUWP
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "OptionsWindowsUWP"));
	}
	...
	template <typename T = bool> T IsModified() {
		return ((T (*)(OptionsWindowsUWP*))(Il2CppBase() + 0x41214A8))(this);
	}
	template <typename T = bool> T xLuaBaseProxy_IsModified() {
		return ((T (*)(OptionsWindowsUWP*))(Il2CppBase() + 0x412159C))(this);
	}
