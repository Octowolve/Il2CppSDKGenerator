...
class USSetAnimatorFloat
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "WellFired", "USSetAnimatorFloat"));
	}
	...
	template <typename T = float> T& prevValue() {
	...
	template <typename T = void> T FireEvent() {
		return ((T (*)(USSetAnimatorFloat*))(Il2CppBase() + 0x4A47290))(this);
	}
	template <typename T = void> T ProcessEvent(float runningTime) {
		return ((T (*)(USSetAnimatorFloat*, float))(Il2CppBase() + 0x4A474C8))(this, runningTime);
	}
	template <typename T = void> T StopEvent() {
		return ((T (*)(USSetAnimatorFloat*))(Il2CppBase() + 0x4A47708))(this);
	}
	template <typename T = void> T UndoEvent() {
		return ((T (*)(USSetAnimatorFloat*))(Il2CppBase() + 0x4A477B8))(this);
	}
	template <typename T = void> T xLuaBaseProxy_StopEvent() {
		return ((T (*)(USSetAnimatorFloat*))(Il2CppBase() + 0x4A47918))(this);
	}
	template <typename T = void> T xLuaBaseProxy_UndoEvent() {
		return ((T (*)(USSetAnimatorFloat*))(Il2CppBase() + 0x4A47920))(this);
	}
