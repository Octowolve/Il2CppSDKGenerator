...
class LoadoutBrParachuteEquipmentView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameUI", "LoadoutBrParachuteEquipmentView"));
	}
	...
	template <typename T = void> T ResetAllTab() {
		return ((T (*)(LoadoutBrParachuteEquipmentView*))(Il2CppBase() + 0x1A00DC8))(this);
	}
	template <typename T = void> T ShowFilterView() {
		return ((T (*)(LoadoutBrParachuteEquipmentView*))(Il2CppBase() + 0x1A01064))(this);
	}
	template <typename T = bool> static T ShowFilterViewm__0(uintptr_t it) {
		return ((T (*)(void *, uintptr_t))(Il2CppBase() + 0x1A013F8))(0, it);
	}
