...
class CodLiveOpsDailyTaskView
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "LiveOps", "CodLiveOpsDailyTaskView"));
	}
	...
	template <typename T = void> T UpdateView(uintptr_t activity) {
		return ((T (*)(CodLiveOpsDailyTaskView*, uintptr_t))(Il2CppBase() + 0x3535D04))(this, activity);
	}
