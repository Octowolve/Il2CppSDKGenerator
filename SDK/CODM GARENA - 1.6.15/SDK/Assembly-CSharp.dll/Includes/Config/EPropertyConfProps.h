...
class EPropertyConfProps
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "Config", "EPropertyConfProps"));
	}
	...
	template <typename T = uintptr_t> static T& PropertyCount() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
