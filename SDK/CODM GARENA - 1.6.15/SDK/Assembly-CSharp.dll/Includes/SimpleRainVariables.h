...
class SimpleRainVariables
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "SimpleRainVariables"));
	}
	...
	template <typename T = bool> T& AutoRotate() {
	...
	template <typename T = float> T& SizeMinY() {
		return *(T*)((uintptr_t)this + 0x54);
	}
	template <typename T = float> T& SizeMaxY() {
		return *(T*)((uintptr_t)this + 0x58);
	}
	template <typename T = uintptr_t> T& SizeOverLifetime() {
	...
	template <typename T = uintptr_t> T& PosYOverLifetime() {
