...
public: 
	...
	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GCloud", "ErrorCode"));
	}
	...
	template <typename T = uintptr_t> static T& PlatformNotFound() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& LbsNeedOpenLocation() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& LbsLocateFail() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
