...
class StartAssetListRequest
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "StartAssetListRequest"));
	}
	...
	template <typename T = void> T Excute() {
		return ((T (*)(StartAssetListRequest*))(Il2CppBase() + 0x493E024))(this);
	}
	template <typename T = void> T xLuaBaseProxy_Excute() {
		return ((T (*)(StartAssetListRequest*))(Il2CppBase() + 0x493E1FC))(this);
	}
