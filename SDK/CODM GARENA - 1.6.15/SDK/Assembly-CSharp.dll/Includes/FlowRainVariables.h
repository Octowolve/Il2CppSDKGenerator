...
class FlowRainVariables
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "FlowRainVariables"));
	}
	...
	template <typename T = float> T& Resolution() {
	...
	template <typename T = float> T& fluctuationRateMin() {
		return *(T*)((uintptr_t)this + 0x7C);
	}
	template <typename T = float> T& fluctuationRateMax() {
