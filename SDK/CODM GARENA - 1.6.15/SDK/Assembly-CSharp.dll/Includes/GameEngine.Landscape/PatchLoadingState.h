...
class PatchLoadingState
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "GameEngine.Landscape", "PatchLoadingState"));
	}
	...
	template <typename T = uintptr_t> static T& PendingLoaded() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
